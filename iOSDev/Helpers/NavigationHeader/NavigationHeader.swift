...
class NavigationHeader {
    ...
    lazy var backButton: UIButton = getActionButton(origin: CGPoint(x: 0, y: 9), icon: UIImage(named: "backIcon")!, action: backAction)
    ...
    lazy var dateStack: UIStackView = {
        ...
        return $0
    }(UIStackView(frame: CGRect(x: 80, y: 0, width: 200, height: 44)))
