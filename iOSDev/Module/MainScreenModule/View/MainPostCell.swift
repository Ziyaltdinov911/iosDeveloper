...
class MainPostCell: UICollectionViewCell {
    ...
    lazy var addFavoriteButton: UIButton = {
        ...
        $0.setBackgroundImage(UIImage(named: "favoriteBtn"), for: .normal)
        $0.tintColor = .black
        return $0
    ...
    func configureCell(item: PostItem) {
        ...
        let tagCollection = TagCollectionView(dataSource: self)
        ...
        [countLabelStack, tagCollectionView, postDescriptionLabel].forEach {
            addSubview($0)
        }
